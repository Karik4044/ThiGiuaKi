...
public class Main {
    public static void main(String[] args) {
        ...
        ChuyenBay chuyenBay1 = new ChuyenBay("CB0001", "SGN", "HN", "01/01/2024", "10:00", 1, 40, new Ghe[120], 'S', new Ticket[100], 1000);
        ChuyenBay chuyenBay2 = new ChuyenBay("CB0002", "HN", "DN", "02/01/2024", "12:00", 1, 40, new Ghe[120], 'S', new Ticket[100], 800);
        ChuyenBay chuyenBay3 = new ChuyenBay("CB0003", "HA", "CT", "02/01/2025", "13:00", 1, 40, new Ghe[120], 'S', new Ticket[100], 500);

        // Them chuyen bay vao hang bay
        hangBay1.themChuyenBay(chuyenBay1);
        hangBay1.themChuyenBay(chuyenBay2);
        hangBay1.themChuyenBay(chuyenBay3);
        ...
        HanhKhach hanhKhach3 = new HanhKhach("KH005", "Tran Thi C", 1988, "87654322", "HB003", "MT003", 18500, 'S', new Ticket[5], "HCM");

        // Them hanh khach vao hang bay
        hangBay1.themHanhKhach(hanhKhach1);
        hangBay1.themHanhKhach(hanhKhach2);
        hangBay1.themHanhKhach(hanhKhach3);
